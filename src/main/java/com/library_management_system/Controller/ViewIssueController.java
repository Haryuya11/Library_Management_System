...
public class ViewIssueController implements Initializable {
    @FXML
    ...
    public void showAllIssuedBooks() {
        try {
            ...
            List<IssueBook> issues = IssueBookDAO.showAllIssuedBooks();
            if (issues.isEmpty()) {
                showAlert(Alert.AlertType.INFORMATION, "No issued found at current");
            } else {
